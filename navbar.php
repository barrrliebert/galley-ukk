        ...
        <div class="flex items-center justify-center">
            <div class="relative w-80">
                <input type="text" name="search" placeholder="Search..."
                    class="border border-gray-300 px-4 py-2 rounded-full w-full pr-10">
                <button type="submit" class="absolute inset-y-0 right-0 flex items-center px-3 text-gray-400 bg-transparent rounded-r-md hover:text-black">
